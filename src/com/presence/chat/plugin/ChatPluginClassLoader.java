...
*/
public class ChatPluginClassLoader extends ClassLoader {
     ...
     */
	public ChatPluginClassLoader(String path) {
		init(path);
	}
	
	/** This version of the constructor is used when ImageJ is launched using Java WebStart. */
	public ChatPluginClassLoader(String path, boolean callSuper) {

...
public class ChatServer {
    ...
    public ChatServer() throws Exception {
        ...
        ChatServer.getNotificationCenter().post(new NotificationEvent("ServerShutdown", null));
	...
	*/
    public static String makeANSI(String str) {
        str = str.replace("&k", BLK).replace("&r", RED).replace("&g", GRN).replace("&y", YEL).replace("&b", BLU)
                 .replace("&m", MAG)
